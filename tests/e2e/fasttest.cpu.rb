...
class TestCpu < Minitest::Test
    def test_mode_1
        stdout, stderr, status = Open3.capture3('./bin/3bc-debug', :stdin_data => "mode 0 1\nstrb 0 0b1\nstri 0 0i9\nstrc 0 'a'\nstro 0 0o7\nstrx 0 0xA")
    ...
    def test_mode_2
        stdout, stderr, status = Open3.capture3('./bin/3bc-debug', :stdin_data => "mode 0 2\nstrb 0 0b1\nstri 0 0d9\nstrc 0 'a'\nstro 0 0o7\nstrx 0 0xA")
        assert_equal "", stderr
    ...
    def test_mode_3
        stdout, stderr, status = Open3.capture3('./bin/3bc-debug', :stdin_data => "mode 0 3\nstrb 1 0\n1\nstro 2 0\n2\nstri 3 0\n3\nstrx 4 0\n4strc 5 0\n5\nmode 0 2\nstrb 1 0\nstro 2 0\nstri 3 0\nstrx 4 0\nstrc 5 0")
        assert_equal "", stderr
    ...
    def test_mode_4
        stdout, stderr, status = Open3.capture3('./bin/3bc-debug', :stdin_data => "mode 0 4\nstrb 1 0\n1\nstro 2 0\n2\nstri 3 0\n3\nstrx 4 0\n4strc 5 0\n5\nmode 0 2\nstrb 1 0\nstro 2 0\nstri 3 0\nstrx 4 0\nstrc 5 0")
        assert_equal "", stderr
    ...
    def test_mode_5
        stdout, stderr, status = Open3.capture3('./bin/3bc-debug', :stdin_data => "mode 0 5\nstrb 1 0\n1\nstro 2 0\n2\nstri 3 0\n3\nstrx 4 0\n4strc 5 0\n5\nmode 0 2\nstrb 1 0\nstro 2 0\nstri 3 0\nstrx 4 0\nstrc 5 0")
        assert_equal "", stderr
        assert_equal "*****12345", stdout
        assert_equal 0, status
    end
    ...
    def test_mode_6
        ...
        stdout, stderr, status = Open3.capture3('./bin/3bc-debug', :stdin_data => console_input.join("\n"))
        assert_equal "", stderr
    ...
    def test_mode_9
        ...
        stdout, stderr, status = Open3.capture3('./bin/3bc-debug', :stdin_data => console[:input])
        assert_equal "", stderr
    ...
    def test_mode_11
        stdout, stderr, status = Open3.capture3('./bin/3bc-debug', :stdin_data => "mode 0 8\naloc 0 8\nmode 0 11\nmath 0 4\nmode 0 8\npull 'r' nill\nmode 0 2\nstri 'r' nill")
        assert_equal "", stderr
    ...
    def test_mode_21
        stdout, stderr, status = Open3.capture3('./bin/3bc-debug', :stdin_data => "mode.0.8,aloc.0.0b10,mode.0.21,math.0.0,mode.0.8,pull.1.0,mode.0.2,strb.1.0")
        assert_equal "", stderr
    ...
    def test_mode_22
        stdout, stderr, status = Open3.capture3('./bin/3bc-debug', :stdin_data => "mode.0.8,aloc.0.0b1100,mode.0.22,math.0.0b1010,mode.0.8,pull.1.0,mode.0.2,strb.1.0")
        assert_equal "", stderr
    ...
    def test_mode_23
        stdout, stderr, status = Open3.capture3('./bin/3bc-debug', :stdin_data => "mode.0.8,aloc.0.0b1100,mode.0.23,math.0.0b1010,mode.0.8,pull.1.0,mode.0.2,strb.1.0")
        assert_equal "", stderr
    ...
    def test_mode_24
        stdout, stderr, status = Open3.capture3('./bin/3bc-debug', :stdin_data => "mode.0.8,aloc.0.0b1100,mode.0.24,math.0.0b1010,mode.0.8,pull.1.0,mode.0.2,strb.1.0")
        assert_equal "", stderr
    ...
    def test_mode_25
        stdout, stderr, status = Open3.capture3('./bin/3bc-debug', :stdin_data => "mode.0.8,aloc.0.0b1100,mode.0.25,math.0.0b1010,mode.0.8,pull.1.0,mode.0.2,strb.1.0")
        assert_equal "", stderr
        assert_equal "-1001", stdout
        assert_equal 0, status
    end 
    ...
    def test_mode_26
        stdout, stderr, status = Open3.capture3('./bin/3bc-debug', :stdin_data => "mode.0.8,aloc.0.0b1100,mode.0.26,math.0.0b1010,mode.0.8,pull.1.0,mode.0.2,strb.1.0")
        assert_equal "", stderr
    ...
    def test_mode_27
        stdout, stderr, status = Open3.capture3('./bin/3bc-debug', :stdin_data => "mode.0.8,aloc.0.0b1100,mode.0.27,math.0.0b1010,mode.0.8,pull.1.0,mode.0.2,strb.1.0")
        assert_equal "", stderr
    ...
    def test_mode_28
        stdout, stderr, status = Open3.capture3('./bin/3bc-debug', :stdin_data => "mode.0.8,aloc.0.0b10,mode.0.28,math.0.0b1,mode.0.8,pull.1.0,mode.0.2,strb.1.0")
        assert_equal "", stderr
    ...
    def test_mode_29
        stdout, stderr, status = Open3.capture3('./bin/3bc-debug', :stdin_data => "mode.0.8,aloc.0.0b10,mode.0.29,math.0.0b1,mode.0.8,pull.1.0,mode.0.2,strb.1.0")
        assert_equal "", stderr
    ...
    def test_mode_31
        stdout, stderr, status = Open3.capture3('./bin/3bc-debug', :stdin_data => "mode.0.31,math.0.0,mode.0.8,pull.1.0,aloc.0.8,mode.0.31,math.0.0,mode.0.8,pull.2.0,mode.0.2,stri.1.0,stri.2.0")
        assert_equal "", stderr
    ...
    def test_mode_41
        ...
        stdout, stderr, status = Open3.capture3('./bin/3bc-debug', :stdin_data => console_input)
    ...
    def test_mode_43
        stdout, stderr, status = Open3.capture3('./bin/3bc-debug', :stdin_data => 'mode.0.43,real.:t.0,fake.:t.0,micr.:t.0,mili.:t.0,seco.:t.0,mode.0.2,strc.0.\'!\'')
        assert_equal "!", stdout
        assert_equal 0, status
    end
end
