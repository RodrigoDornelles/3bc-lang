...
void driver_program_error(enum error_3bc_e error_code)
{
    ...
    switch((long) (error_code))
    {
        ...
        ERROR_LOG_3BC(ERROR_TAPE_SORT, "FAILURE TO EXPAND THE SORT");
        ...
        ERROR_LOG_3BC(ERROR_LONG_LINE, "EXCEED LINE COLUMN LIMIT");
