...
bool driver_idle(struct app_3bc_s* const app)
{
    switch(app->cache_l1.sleep_mode)
    {
        ...
        case SLEEP_3BC_MICROSECONDS:
            ...
            else if ((global_time.ts.tv_nsec - app->cache_l3.sleep_called) >= 1000){
                app->cache_l3.sleep_called = global_time.ts.tv_nsec; /** reset ref **/
       ...
       case SLEEP_3BC_MILLISECONDS:
            ...
            else if ((global_time.ts.tv_nsec - app->cache_l3.sleep_called) >= 1000000LU){
                app->cache_l3.sleep_called = global_time.ts.tv_nsec; /** reset ref **/
                app->cache_l2.sleep_period -= 1; /** decrease seconds left **/
            }
