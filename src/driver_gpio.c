...
void driver_gpio_setup(struct app_3bc_s *const app, memory_conf_t conf, address_3bc_t pin)
{
...
void driver_gpio_output(
    struct app_3bc_s *const app, memory_conf_t conf, address_3bc_t pin, data_3bc_t data)
{
    if (conf == 0) {
        return;
    }
