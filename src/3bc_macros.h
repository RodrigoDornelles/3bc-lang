 ...
 */
#define CPU_PACK_ZEROMODE(mode)     case((mode*7)+1):case((mode*7)+2):case((mode*7)+3):case((mode*7)+4):case((mode*7)+5):case((mode*7)+6):cpu_not_mode(app,reg,address,value);break;
#define CPU_PACK_RESERVED(mode)     case((mode*7)+1):case((mode*7)+2):case((mode*7)+3):case((mode*7)+4):case((mode*7)+5):case((mode*7)+6):cpu_mode_reserved(app,reg,address,value);break;
#define CPU_PACK1(mode,a)           case((mode*7)+1):a(app,reg,address,value);break;
#define CPU_PACK2(mode,a,b)         case((mode*7)+1):a(app,reg,address,value);break;case((mode*7)+2):b(app,reg,address,value);break;
#define CPU_PACK3(mode,a,b,c)       case((mode*7)+1):a(app,reg,address,value);break;case((mode*7)+2):b(app,reg,address,value);break;case((mode*7)+3):c(app,reg,address,value);break;
